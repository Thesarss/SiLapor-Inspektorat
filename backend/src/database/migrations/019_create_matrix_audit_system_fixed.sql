-- Migration: Create Matrix Audit System (Fixed - No Conflicts)
-- System for Inspektorat to upload Excel audit findings and OPD to respond with follow-up actions

-- Drop old matrix tables from migration 018 if they exist
DROP TABLE IF EXISTS matrix_field_reviews;
DROP TABLE IF EXISTS matrix_reviews;
DROP TABLE IF EXISTS matrix_responses;
DROP TABLE IF EXISTS matrix_assignments;
DROP TABLE IF EXISTS matrix_fields;
